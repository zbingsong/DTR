...
path = '/storage/jmabq/VirtualStaining/downstream_tasks/GCHTID/HMU-GC-HE-30K/all_image'
...
with open('/jhcnas3/VirtualStaining/downstream_tasks/labels/GCHTID_labels.csv', 'w') as f:
